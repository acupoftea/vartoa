      	...
      	<form class="form-horizontal">
           <div class="box-body">
             <div class="form-group">
	          ...
	          <a href="#" id="udfEdit_downloadUrl" target="_blank" >查看上传文件</a>&nbsp;&nbsp;&nbsp;<a href="#" ng_click="deleteAttachment('from_edit')" >删除</a>
	          </div>
	              </div>
	            </div>
	            ...
	            <button class="btn btn-primary" data-toggle="modal" data-target="#myModalSelectContrl" data-src="edit" id="selectControlSrc2">添加</button>
	            <div style="height:3px"></div>
	            
	            <table id="udfTable4Edit" class="table table-bordered table-hover" >
	                <thead>
	                <tr>
	                  <th>显示顺序</th>
	                  <th>是否必填</th>
