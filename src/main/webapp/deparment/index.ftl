        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>部门管理</b></h3>
            </div>
...
var table = null;
  $(function () {
	 table = $('#example2').DataTable({
      ...
      "processing": true,
      "serverSide": true,
      "ajax": _serverPath + "/Commander?beanId=deparmentService&bizType=query&companyId=" + companyId,
      "columns": [
                  {"data": "index"},
                  {"data": "id"},
...
<script src="deparment/controller.js"></script>